      ...
      <div className="flex items-center justify-between px-4 py-2.5 bg-[#13131A] border-b border-[#1E1E2A] text-xs text-slate-300">
        ...
        <div className="flex items-center gap-2">
          ...
          {onOpenDiagnostics && (
            <button
              type="button"
              id="btn-video-integrity-check"
              onClick={onOpenDiagnostics}
              className="flex items-center gap-1.5 px-3 py-1 rounded-xl bg-emerald-500/15 hover:bg-emerald-500/25 text-emerald-300 border border-emerald-500/30 text-[11px] font-semibold transition active:scale-95 shadow-sm cursor-pointer"
              title="Run Diagnostic Video Integrity Check (Container, Codec, Audio/Video Stream Sync)"
            >
              <ShieldCheck className="w-3.5 h-3.5 text-emerald-400" />
              <span className="hidden sm:inline">Integrity Check</span>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {onOpenDiagnostics && (
              <button
                type="button"
                onClick={onOpenDiagnostics}
                className="hidden md:inline-flex items-center gap-1.5 text-[10px] px-2.5 py-0.5 rounded-lg bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-300 border border-emerald-500/25 transition cursor-pointer font-mono"
                title="Audio/Video stream synchronization status"
              >
